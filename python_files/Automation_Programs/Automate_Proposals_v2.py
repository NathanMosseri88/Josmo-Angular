...
from Database_Modules import ProgramCredentials, engine_setup, get_proper_engine, print_color, create_folder
...
def data_setup(engine=None, styles=None,  data_folder=None, file_name=None, Price=False, Cost=False, Average_Cost=False,
    ...
    if UPC is True and active_only is False and include_0_quantites is True:
        ...
        data_table = f'{data_folder}Data Files\\proposal_data_files\\size_run_data_setup.csv'
    elif UPC is False and Size_Run is True and Size_Detail is False and include_0_quantites is True:
        data_table = f'{data_folder}Data Files\\proposal_data_files\\size_run_data_setup_all.csv'
    ...
    print_color(f'{query}', color='y')



    data_df = pd.read_sql(query, con=engine)
    print_color(data_df, color='y')
...
def generate_proposal_sheet(engine=None, styles=None, data_folder=None, file_name=None, Price=False, Cost=False,
    ...
    # df_for_export, df = \
    data_setup(engine=engine, styles=styles,  data_folder=data_folder, file_name=file_name, Price=Price, Cost=Cost,
...
def generate_web_proposal(styles):
    ...
    print_color(f'styles: {styles}', color='y')
    # folder = sys.argv[2]
    ...
    generate_proposal_sheet(engine=engine, styles=styles, UPC=True, active_only=False, include_0_quantites=True)
      ...
      #                       include_stock_or_no_stock=include_stock_or_no_stock, Size_Detail=Size_Detail,
